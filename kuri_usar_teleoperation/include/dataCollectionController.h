#ifndef DATACOLLECTIONCONTROLLER_H
#define DATACOLLECTIONCONTROLLER_H
...
private:
   // ArdroneInterface    interface_;
    ...
    void sendVel(geometry_msgs::TwistStamped & vel, geometry_msgs::TwistStamped & key );
};

#endif // DATACOLLECTIONCONTROLLER_H
